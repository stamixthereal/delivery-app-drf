...
PHONE_METADATA_TM = PhoneMetadata(id='TM', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='0[1-49]', example_number='01', possible_length=(2,)),
    emergency=PhoneNumberDesc(national_number_pattern='0[1-3]', example_number='01', possible_length=(2,)),
    short_code=PhoneNumberDesc(national_number_pattern='0[1-49]', example_number='01', possible_length=(2,)),
    short_data=True)
