...
PHONE_METADATA_LT = PhoneMetadata(id='LT', country_code=370, international_prefix='00',
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='80[02]\\d{5}', example_number='80012345', possible_length=(8,)),
    ...
    personal_number=PhoneNumberDesc(national_number_pattern='70[05]\\d{5}', example_number='70012345', possible_length=(8,)),
    voip=PhoneNumberDesc(national_number_pattern='[89]01\\d{5}', example_number='80123456', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['52[0-7]'], national_prefix_formatting_rule='(8-\\1)', national_prefix_optional_when_formatting=True),
