...
PHONE_METADATA_SV = PhoneMetadata(id='SV', country_code=503, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:[1-6]\\d{3}|[79]90[034]|890[0245])\\d{3}', example_number='21234567', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='66(?:[02-9]\\d\\d|1(?:[02-9]\\d|16))\\d{3}|(?:6[0-57-9]|7\\d)\\d{6}', example_number='70123456', possible_length=(8,)),
