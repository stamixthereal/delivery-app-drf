...
PHONE_METADATA_EG = PhoneMetadata(id='EG', country_code=20, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='13[23]\\d{6}|(?:15|57)\\d{6,7}|(?:2[2-4]|3|4[05-8]|5[05]|6[24-689]|8[2468]|9[235-7])\\d{7}', example_number='234567890', possible_length=(8, 9), possible_length_local_only=(6, 7)),
