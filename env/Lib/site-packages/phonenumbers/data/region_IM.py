...
PHONE_METADATA_IM = PhoneMetadata(id='IM', country_code=44, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1624(?:230|[5-8]\\d\\d)\\d{3}', example_number='1624756789', possible_length=(10,), possible_length_local_only=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='76245[06]\\d{4}|7(?:4576|[59]24\\d|624[0-4689])\\d{5}', example_number='7924123456', possible_length=(10,)),
