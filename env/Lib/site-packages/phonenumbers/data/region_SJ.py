...
PHONE_METADATA_SJ = PhoneMetadata(id='SJ', country_code=47, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='0\\d{4}|(?:[489]\\d|[57]9)\\d{6}', possible_length=(5, 8)),
    fixed_line=PhoneNumberDesc(national_number_pattern='79\\d{6}', example_number='79123456', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:4[015-8]|59|9\\d)\\d{6}', example_number='41234567', possible_length=(8,)),
