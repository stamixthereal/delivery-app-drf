...
PHONE_METADATA_EC = PhoneMetadata(id='EC', country_code=593, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='1\\d{9,10}|(?:[2-7]|9\\d)\\d{7}', possible_length=(8, 9, 10, 11), possible_length_local_only=(7,)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='964[0-2]\\d{5}|9(?:39|[57][89]|6[0-36-9]|[89]\\d)\\d{6}', example_number='991234567', possible_length=(9,)),
    toll_free=PhoneNumberDesc(national_number_pattern='1800\\d{7}|1[78]00\\d{6}', example_number='18001234567', possible_length=(10, 11)),
