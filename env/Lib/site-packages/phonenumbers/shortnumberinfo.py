...
from .phonenumberutil import (_PLUS_CHARS_PATTERN, _extract_possible_number,
                              _match_national_number,
...
try:
    from .shortdata import \
        _AVAILABLE_REGION_CODES as _AVAILABLE_SHORT_REGION_CODES
